...
<?php $__env->startSection('title', 'Manage Submenus'); ?>
                ...
                <div class="mb-3">
                    ...
                    <select class="select2 form-control" id="Menu_ID" name="intMenu_ID">
                        ...
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        
                            <option value="<?php echo e($item->intMenu_ID); ?>"><?php echo e($item->txtMenuTitle); ?></option>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('manage.submenu.index')); ?>",
            columns: [
        ...
        function create(){
            ...
            url = "<?php echo e(route('manage.submenu.store')); ?>";
            method = "POST";
        }
        function edit(id){
            $('.modal-header h4').html('Edit Submenu');
            $('.modal-body form').append('<input type="hidden" name="_method" value="PUT">');
            let editUrl = "<?php echo e(route('manage.submenu.edit',':id')); ?>";
            editUrl = editUrl.replace(':id', id);
            url = "<?php echo e(route('manage.submenu.update', ':id')); ?>";
        ...
        function destroy(id){
            let deleteUrl = "<?php echo e(route('manage.submenu.destroy', ':id')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\standardization\resources\views/pages/admin/manage-submenu.blade.php ENDPATH**/ ?>