...
<?php $__env->startSection('title', 'Manage Levels'); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('manage.level.index')); ?>",
            columns: [
        ...
        function create(){
            ...
            url = "<?php echo e(route('manage.level.store')); ?>";
            method = "POST";
        }
        function edit(id){
            $('.modal-header h4').html('Edit Level');
            let editUrl = "<?php echo e(route('manage.level.edit',':id')); ?>";
            editUrl = editUrl.replace(':id', id);
            url = "<?php echo e(route('manage.level.update', ':id')); ?>";
        ...
        function access(id){
            ...
            let accessUrl = "<?php echo e(route('manage.level.access',':id')); ?>";
            accessUrl = accessUrl.replace(':id', id);
            url = "<?php echo e(route('manage.level.change', ':id')); ?>";
            url = url.replace(':id', id);
        ...
        function destroy(id){
            let deleteUrl = "<?php echo e(route('manage.level.destroy', ':id')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\standardization\resources\views/pages/admin/manage-levels.blade.php ENDPATH**/ ?>