...
<body class="<?php echo e($bodyClass); ?>">
	...
	<div id="app" class="app app-sidebar-fixed <?php echo e($appClass); ?>">
		...
		<?php echo $__env->renderWhen($appTopMenu, 'includes.top-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
		
		<?php echo $__env->renderWhen(!$appSidebarHide, 'includes.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
...
<?php /**PATH C:\laragon\www\standardization\resources\views/layouts/default_layout.blade.php ENDPATH**/ ?>