          ...
          <form action="" method="post" id="form-level" data-parsley-validate="true">
            <div class="mb-3">
                ...
                <select class="select2 form-control" id="Locater" name="intLocater_ID" data-parsley-required="true">
                    <?php $__currentLoopData = $locaters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        
                        <option value="<?php echo e($item->intLocater_ID); ?>"><?php echo e($item->txtLocaterName); ?></option>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('roonline.manage.device')); ?>",
            columns: [
        ...
        function edit(id){
            ...
            let editUrl = "<?php echo route('roonline.manage.device.edit', ':id'); ?>";
            editUrl = editUrl.replace(':id', id);
            url = "<?php echo e(route('roonline.manage.device.update', ':id')); ?>";
        ...
        $(document).ready(function(){
            ...
            $('#form-level').on('submit', function(e){
                ...
                formData.append('txtInsertedBy', "<?php echo e(Auth::user()->txtName); ?>");
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('roonline::layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\standardization\Modules/ROonline\Resources/views/pages/admin/devices.blade.php ENDPATH**/ ?>