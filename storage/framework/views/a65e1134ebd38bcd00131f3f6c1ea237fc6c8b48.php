...
<head>
	<?php echo $__env->make('faceid::includes.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</head>
<?php
...
<body class="<?php echo e($bodyClass); ?>">
	<?php echo $__env->make('faceid::includes.component.page-loader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

	<div id="app" class="app app-sidebar-fixed <?php echo e($appClass); ?>">

		<?php echo $__env->renderWhen(!$appHeaderHide, 'faceid::includes.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>

		<?php echo $__env->renderWhen($appTopMenu, 'faceid::includes.top-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>

		<?php echo $__env->renderWhen(!$appSidebarHide, 'faceid::includes.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
		...
		<?php echo $__env->make('faceid::includes.component.scroll-top-btn', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<?php echo $__env->make('faceid::includes.page-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>

</html><?php /**PATH /Users/mac/Documents/tazaka/standardization/Modules/Faceid/Resources/views/layouts/default_layout.blade.php ENDPATH**/ ?>