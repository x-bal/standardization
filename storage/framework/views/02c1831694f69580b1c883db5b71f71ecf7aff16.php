...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('manage.menu.index')); ?>",
            columns: [
        ...
        function create(){
            ...
            url = "<?php echo e(route('manage.menu.store')); ?>";
            method = "POST";
        }
        function edit(id){
            $('.modal-header h4').html('Edit Level');
            let editUrl = "<?php echo e(route('manage.menu.edit',':id')); ?>";
            editUrl = editUrl.replace(':id', id);
            url = "<?php echo e(route('manage.menu.update', ':id')); ?>";
        ...
        function destroy(id){
            let deleteUrl = "<?php echo e(route('manage.menu.destroy', ':id')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\standardization\resources\views/pages/admin/manage-menu.blade.php ENDPATH**/ ?>