...
<?php $__env->startSection('title', 'Manage DB Accounts | Standardization'); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('manage.dbaccount.index')); ?>",
            columns: [
        ...
        function create(){
            ...
            url = "<?php echo e(route('manage.dbaccount.store')); ?>";
            method = "POST";
        }
        function edit(id){
            $('.modal-header h4').html('Edit DB Account');
            let editUrl = "<?php echo e(route('manage.dbaccount.edit',':id')); ?>";
            editUrl = editUrl.replace(':id', id);
            url = "<?php echo e(route('manage.dbaccount.update', ':id')); ?>";
        ...
        function destroy(id){
            let deleteUrl = "<?php echo e(route('manage.dbaccount.destroy', ':id')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\standardization\resources\views/pages/admin/manage-dbaccount.blade.php ENDPATH**/ ?>