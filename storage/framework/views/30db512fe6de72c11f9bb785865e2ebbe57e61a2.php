            ...
            <div class="panel-body">
                <div class="row mb-3">
                    <div class="col-md-12 ms-auto">
                        <a href="#modal-dialog" id="btn-add" class="btn btn-primary" data-route="<?php echo e(route('faceid.device.store')); ?>" data-bs-toggle="modal"><i class="ion-ios-add"></i> Add Device</a>
                    </div>
                </div>
                <div class="row">
                    <!-- html -->
...
<script>
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('faceid.device.list')); ?>",
        deferRender: true,
        pagination: true,
        columns: [{
                data: 'DT_RowIndex',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('faceid::layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Documents/tazaka/standardization/Modules/Faceid/Resources/views/pages/device/index.blade.php ENDPATH**/ ?>